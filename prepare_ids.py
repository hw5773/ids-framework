...
def make_config(ofname, anames, enames, pnames, fnames):
...
def make_initializer(anames, enames, pnames, fnames):
    ...
    with open("iutils/eutils.py", "w") as of:
        of.write("import sys\n")
        of.write("sys.path.append(\"..\")\n")
...
def main():
    ...
    make_config(args.output, anames, enames, pnames, fnames)
    make_initializer(anames, enames, pnames, fnames)
