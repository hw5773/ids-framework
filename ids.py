...
class IDSCore:
    def __init__(self, conf, sidx, ofname, serial=None, evolve=-1):
        tsname = "../ids-dataset/set_{}/training.pcap".format(sidx)
        tiname = "../ids-dataset/set_{}/training.info".format(sidx)

        esname = "../ids-dataset/set_{}/test.pcap".format(sidx)
        einame = "../ids-dataset/set_{}/test.info".format(sidx)

        rsname = None
        riname = None
        if evolve > 0:
            rsname = "../ids-dataset/set_{}/test.pcap".format(evolve)
            riname = "../ids-dataset/set_{}/test.info".format(evolve)
